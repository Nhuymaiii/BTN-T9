d3.dsv(";", "data/data_ggsheet.csv").then(data => {
    ...
    d3.select("#insight4")
        ...
        Năm qua, Thứ 7 là ngày bán chạy nhất với doanh thu trung bình 14,493,547 VNĐ (280 SKU), do cuối tuần khách hàng có thời gian rảnh, nhu cầu mua sắm tăng, trong khi Thứ 3 bán kém nhất với doanh thu trung bình 11,891,769 VNĐ (229 SKU), vì giữa tuần khách hàng bận làm việc, ít thời gian mua sắm. <br>
            <br>
        Đề xuất: tăng khuyến mãi vào Thứ 7 với giảm giá, sự kiện đặc biệt; kích cầu vào Thứ 3 bằng flash sale, ưu đãi.
